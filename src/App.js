  ...
  useEffect(() => {
    switch (category) {
      case "operating systems":
        setFilteredArticles(
          articles.filter((article) => {
            return article.category === "OPERATING SYSTEMS";
          })
        );
        break;
      case "printers":
        setFilteredArticles(
          articles.filter((article) => {
            return article.category === "PRINTERS";
          })
        );
        break;
      case "outlook":
        setFilteredArticles(
          articles.filter((article) => {
            return article.category === "OUTLOOK";
          })
        );
        break;
      case "powerpoint":
        setFilteredArticles(
          articles.filter((article) => {
            return article.category === "POWERPOINT";
          })
        );
        break;
      case "active directory":
        setFilteredArticles(
          articles.filter((article) => {
            return article.category === "ACTIVE DIRECTORY";
          })
        );
        break;
      default:
